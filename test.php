...
$wsdl = "services.wsdl";
$wsdl = "https://192.168.0.36/ews/Services.wsdl";
...
class NTLMStream {
	...
	$wsdl2 = "services.wsdl";
	$client = new ExchangeNTLMSoapClient($wsdl2);
	
	/* Do something with the web service connection */
	stream_wrapper_restore('https');

var_dump($client->__getTypes());
$FindFolder = new stdclass();
$FindFolder->Traversal = "Shallow";
	$FindFolder->FolderShape->BaseShape = "Default";
	$FindFolder->ParentFolderIds->DistinguishedFolderId->Id = "calendar";
